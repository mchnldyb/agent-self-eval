    ...
    <div class="container">
        <div class="card-deck mb-3 text-center">
            <div class="card mb-4 shadow-sm">
                ...
                {{--</div>--}}
                <div class="card-body">
                    <h1 class="card-title pricing-card-title"><small class="text-muted">Description here</small></h1>
            ...
            <div class="card mb-4 shadow-sm">
                ...
                {{--</div>--}}
                <div class="card-body">
                    <h1 class="card-title pricing-card-title"><small class="text-muted">View</small></h1>
