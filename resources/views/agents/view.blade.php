        ...
        <div class="col-md-12">
            @if(count($agents))
                ...
                @if($avg_rating)
                    ...
                    @switch($avg_rating)
                        @case('1')
                        <div class="float-right"><h2><span class="badge badge-pill badge-danger">Average Rating : {{ $avg_rating }}</span></h2></div>
                        @break

                        @case('2')
                        <div class="float-right"><h2><span class="badge badge-pill badge-warning">Average Rating : {{ $avg_rating }}</span></h2></div>
                        @break

                        @case('3')
                        <div class="float-right"><h2><span class="badge badge-pill badge-secondary">Average Rating : {{ $avg_rating }}</span></h2></div>
                        @break

                        @case('4')
                        <div class="float-right"><h2><span class="badge badge-pill badge-primary">Average Rating : {{ $avg_rating }}</span></h2></div>
                        @break

                        @case('5')
                        <div class="float-right"><h2><span class="badge badge-pill badge-success">Average Rating : {{ $avg_rating }}</span></h2></div>
                        @break
